...
This test app is an iOS application performing login a user and retrieve all his investor products using Moneybox API. User session is saved securely inside the Apple Keychain but the products are fetched at each session.
